...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('trend', '0027_alter_dpr_table1_performance_at_acceptance_date_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.DateField(blank=True, null=True, validators=[django.core.validators.MaxValueValidator(datetime.date(2023, 2, 14))]),
        ),
        migrations.AlterField(
            model_name='dpr_table1',
